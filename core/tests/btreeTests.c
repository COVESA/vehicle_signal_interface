...
int main ( int argc, char *argv[] )
{
    ...
    //
    btree_t* idTree = btree_create ( 15, 2, 0, 1, 0, 0 );

    printf ( "Created ID B-tree:\n" );
    btree_print ( idTree, 0 );

#ifdef TEST_BTREE_NAMES_INDEX
    // btree_initialize ( nameTree, 20, 2, 0, 1, 0, 0 );
    // nameTree = btree_create ( compareNames, NULL, NULL );
#endif
